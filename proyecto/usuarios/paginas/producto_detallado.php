...
if ($id_producto == '') {
  ...
  echo 'Error al Procesar información';
  exit;
} else {
          ...
          <div class="row">
              ...
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <img src="../dist/img/pic12.jpg" alt="<?php echo $datosproducto['nombre']; ?> " class="img-responsive">
                  ...
                  <div class="item">
                    <img src="../dist/img/pic11.jpg" alt="<?php echo $datosproducto['nombre']; ?>" class="img-responsive">
                    <div class="carousel-caption">
                  ...
                  <div class="item">
                    <img src="../dist/img/pic10.jpg" alt="<?php echo $datosproducto['nombre']; ?>" class="img-responsive">
                    <div class="carousel-caption">
            ...
            <div class="col-md-6" order-md-2>
              ...
              <?php if ($descuento > 0) { ?>
                ...
                <h3>$<?php echo number_format($precio_desc, 2, '.', ','); ?></h3>
                <span class="reducedfrom">$
                  <?php echo number_format($datosproducto['precio_venta'], 2, '.', ','); ?>
              ...
              <?php } else { ?>
                ...
                <h3>$<?php echo number_format($datosproducto['precio_venta'], 2, '.', ','); ?></h3>
